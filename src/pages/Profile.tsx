...
export function Profile() {
  ...
  return (
    <div className="max-w-[900px] mx-auto px-4 md:px-6 py-6 flex flex-col gap-4">
      ...
      <div className="bg-card rounded-3xl border border-border px-8 pt-10 pb-6">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-8">
            <div
              className="w-[120px] h-[120px] rounded-2xl shrink-0 -mt-16 border-2 border-border shadow-2xl"
      ...
      {/* About tab bar */}
      <div className="bg-card rounded-2xl border border-border py-3.5 text-center">
        <span className="text-[14px] font-medium text-foreground">About</span>
      </div>

      {/* About content */}
      <div className="bg-card rounded-3xl border border-border p-8">
        <h2 className="text-[18px] font-bold text-foreground mb-1">About</h2>
        <p className="text-muted-foreground text-[15px] mb-8">Pwo Luduvian</p>

        <h3 className="text-[16px] font-bold text-foreground mb-5">Currently Wearing</h3>
        <div className="flex items-start gap-8">
          <div
            className="w-[200px] h-[250px] rounded-2xl shrink-0 border border-border"
            style={{ background: grad(4) }}
          />
            ...
            <div className="grid grid-cols-4 gap-4">
              {visible.map((item) => (
                <div key={item.index} className="flex flex-col items-center gap-2.5">
                  <div
                    className="w-full aspect-square rounded-2xl bg-secondary/30 p-2"
                  >
